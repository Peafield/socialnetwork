...
func GetUserCommentReaction(db *sql.DB, userId string, commentId string) (*dbmodels.Reaction, error) {
	reactionData, err := crud.SelectFromDatabase(db, "Reactions", dbstatements.SelectCommentReactionStmt, []interface{}{userId, commentId})
